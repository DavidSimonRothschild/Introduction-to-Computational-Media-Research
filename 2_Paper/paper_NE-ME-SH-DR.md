...
Social media have become a central arena of contemporary politics, acting as a powerful tool for political communication and mobilization. By enabling direct, immediate, and large-scale interaction with users, social media platforms such as Instagram and TikTok allow political actors to disseminate messages, build visibility, and engage citizens beyond traditional media channels. Within the social media environment, attention functions as a key resource: social media are governed by an attention logic in which content that generates higher levels of engagement is more likely to be amplified and gain resonance through an algorithmic logic. For political parties, leaning into this engagement logic is crucial, as increased likes, comments, views and shares enhance message visibility, support their mobilization efforts, and can ultimately shape political reach and influence.
...
fög – Forschungszentrum Öffentlichkeit und Gesellschaft / Universität Zürich (2025): Abstimmungsmonitor September 2025 – Schlussbericht Vorlagen vom 28. September 2025 Abstimmungsmonitor Abschaffung Eigenmietwert E-ID-Gesetz Schlussbericht.
