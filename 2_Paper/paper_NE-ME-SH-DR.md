...
Political communication on social media has increased in recent years. However, the Swiss political system has some special features. Mobilisation is mainly focused on political issues and voting decisions, not on individual candidates. Building on Bene (2021), Maitra and Hänggli (2023), and Staender et al. (2019), this paper helps to better understand how engagement and resonance are created on social media in Swiss political communication.

## 2: Literature Review

### 2.1 Shareworthiness - Determinants of User Engagement on Social Media
...
#### 3.1.1: Instagram Engagement Score (mean-centered)
...
#### 3.1.2: TikTok Engagement Score (mean-centered)
...
*Figure 1: Network of cross-party mentions on Instagram*

Figure 2 visualises the network of cross-party mentions on TikTok. Compared to Instagram, the TikTok network is substantially sparser and more centralised around a small number of actors.
...
*Figure 2: Network of cross-party mentions on Tiktok*
